...
| 想了解什么         | 文档                                                                       |
| ------------------ | -------------------------------------------------------------------------- |
| 如何选择视觉与交互 | [设计原则](/docs/design/principles)                                        |
| 如何写默认中文文案 | [语调与文案](/docs/design/voice)                                           |
| 如何使用主题与字体 | [颜色](/docs/design/tokens/colors)、[字体](/docs/design/tokens/typography) |
| 如何安排布局       | [间距、圆角与阴影](/docs/design/tokens/spacing-radii-shadows)              |
| 如何使用组件       | [组件索引](/docs/components)                                               |

第一次接入请先看[快速开始](/docs/getting-started)。
