...
> 聊天专属组件(Message / PromptInput / Suggestion / Reasoning 等)在 portal 仓库文档站维护,不在本表。其总纲见[完整规范 → Component library](../UNIF-DESIGN.md)。
...
| [Thumbnail](thumbnail.md) | 16:9.5 缩略图,sm / md / lg 三档 |
| [Loading](loading.md) | `Spinner`：native Reanimated 旋转 / Web CSS keyframes |
...
| [PasswordInput](password-input.md) | Input + secureTextEntry + 明文切换 |
...
参考实现:[Button](button.md) 与 [Cell · List](cell.md)。
