      ...
      return {
        ...
        resolve: {
          alias: {
            ...
            ...dedupeAlias,
            // react-native-svg 15 仍引用 RN <=0.86 的旧 asset registry 包名。Web
            // 直接复用 RNW Image 使用的同一份 AssetRegistry，既避免把 RN 0.87
            // 带 Flow 类型的原生源码拉进 webpack，也保证注册与读取共享状态。
            // native 消费端继续由 Metro 按各自 RN 版本解析。
